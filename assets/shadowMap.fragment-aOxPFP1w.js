import{d as e}from"./foundation3d-BLXwU5ng.js";import{p as d}from"./packingFunctions-DFUkRKxO.js";import{c as p,a as c}from"./clipPlaneFragment-CO3G2jjH.js";import"./modulepreload-polyfill-B5Qt9EMX.js";const r="bayerDitherFunctions",f=`fn bayerDither2(_P: vec2f)->f32 {return ((2.0*_P.y+_P.x+1.0)%(4.0));}
...
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=f);const h={name:r,shader:f},n="shadowMapFragmentExtraDeclaration",S=`#if SM_FLOAT==0
...
varying zSM: f32;
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=S);const u={name:n,shader:S},t="shadowMapFragment",s=`var depthSM: f32=fragmentInputs.vDepthMetricSM;
#if defined(SM_DEPTHCLAMP) && SM_DEPTHCLAMP==1
#if SM_USEDISTANCE==1
...
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=s);const l={name:t,shader:s},i="shadowMapPixelShader",o=`#include<shadowMapFragmentExtraDeclaration>
#ifdef ALPHATEXTURE
...
}`;e.ShadersStoreWGSL[i]||(e.ShadersStoreWGSL[i]=o);const m=[d,h,u,p,c,l];for(const a of m)e.IncludesShadersStoreWGSL[a.name]||(e.IncludesShadersStoreWGSL[a.name]=a.shader);const T={name:i,shader:o};export{T as shadowMapPixelShaderWGSL};
