import{d as e}from"./foundation3d-BLXwU5ng.js";const t="bonesDeclaration",d=`#if NUM_BONE_INFLUENCERS>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=d);const E={name:t,shader:d},n="bakedVertexAnimationDeclaration",m=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=m);const N={name:n,shader:m},r="clipPlaneVertexDeclaration",o=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=o);const p={name:r,shader:o},i="instancesVertex",u=`#ifdef INSTANCES
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=u);const S={name:i,shader:u},a="bonesVertex",l=`#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=l);const v={name:a,shader:l},s="bakedVertexAnimation",c=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=c);const A={name:s,shader:c},f="clipPlaneVertex",I=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=I);const V={name:f,shader:I};export{N as a,E as b,p as c,v as d,A as e,V as f,S as i};
