import{d as e,v as J,w as K,x as ee,l as ie,m as te}from"./foundation3d-BLXwU5ng.js";import{d as oe,m as re,l as ae}from"./logDepthDeclaration-DXVhjZML.js";import{f as ne,a as le}from"./fogFragment-BvqgMTte.js";import"./modulepreload-polyfill-B5Qt9EMX.js";const t="decalFragmentDeclaration",A=`#ifdef DECAL
...
`;e.ShadersStore[x]||(e.ShadersStore[x]=Q);const Ne=[se,fe,J,K,oe,de,ce,re,ee,ve,he,ue,pe,me,ge,Se,Ee,Ce,De,Te,Le,Ie,we,ie,ae,ne,te,xe,Ae,Pe,Re,Xe,le,Fe];for(const i of Ne)e.IncludesShadersStore[i.name]||(e.IncludesShadersStore[i.name]=i.shader);const be={name:x,shader:Q};export{be as defaultPixelShader};
