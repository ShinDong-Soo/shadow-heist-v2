import{d as e}from"./foundation3d-BLXwU5ng.js";import{s as q,m as j}from"./meshUboDeclaration-COpjDvhq.js";import{d as Z,m as Q,l as J}from"./logDepthDeclaration-CqSA1ezp.js";import{h as K}from"./helperFunctions-Cz5dwElO.js";import{c as ee,a as re}from"./clipPlaneFragment-CO3G2jjH.js";import{f as te,a as ae}from"./fogFragment-CJrNoxM8.js";import"./modulepreload-polyfill-B5Qt9EMX.js";const t="prePassDeclaration",I=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=I);const ie={name:t,shader:I},a="oitDeclaration",D=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=D);const oe={name:a,shader:D},i="lightUboDeclaration",A=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=A);const fe={name:i,shader:A},o="ltcHelperFunctions",P=`fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=P);const ne={name:o,shader:P},f="clusteredLightingFunctions",X=`struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
...
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=X);const se={name:f,shader:X},n="clusteredLightingCompute",R=`#if defined(CLUSTLIGHT{X}) && defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=R);const le={name:n,shader:R},s="lightsFragmentFunctions",_=`struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
#endif
...
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=_);const de={name:s,shader:_},l="shadowsFragmentFunctions",y=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=y);const ce={name:l,shader:y},d="samplerFragmentDeclaration",N=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=N);const ve={name:d,shader:N},c="fresnelFunction",F=`#ifdef FRESNEL
fn computeFresnelTerm(viewDirection: vec3f,worldNormal: vec3f,bias: f32,power: f32)->f32
{let fresnelTerm: f32=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=F);const ue={name:c,shader:F},v="reflectionFunction",M=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=M);const pe={name:v,shader:M},u="imageProcessingDeclaration",O=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=O);const he={name:u,shader:O},p="imageProcessingFunctions",b=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=b);const me={name:p,shader:b},h="textureRepetitionFunctions",W=`#if TEXTURE_REPETITION_MODE>0
...
`;e.IncludesShadersStoreWGSL[h]||(e.IncludesShadersStoreWGSL[h]=W);const Se={name:h,shader:W},m="bumpFragmentMainFunctions",U=`#ifndef TEXRD_DEFINED
fn TEXRD(t: texture_2d<f32>,ts: sampler,uv: vec2f)->vec4f {return textureSample(t,ts,uv);}
#define TEXRD_DEFINED
#endif
...
#endif
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=U);const ge={name:m,shader:U},S="bumpFragmentFunctions",z=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStoreWGSL[S]||(e.IncludesShadersStoreWGSL[S]=z);const xe={name:S,shader:z},g="bumpFragment",G=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[g]||(e.IncludesShadersStoreWGSL[g]=G);const Te={name:g,shader:G},x="decalFragment",H=`#ifdef DECAL
...
#endif
`;e.IncludesShadersStoreWGSL[x]||(e.IncludesShadersStoreWGSL[x]=H);const Le={name:x,shader:H},T="depthPrePass",V=`#ifdef DEPTHPREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[T]||(e.IncludesShadersStoreWGSL[T]=V);const Ce={name:T,shader:V},L="lightFragment",k=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[L]||(e.IncludesShadersStoreWGSL[L]=k);const we={name:L,shader:k},C="logDepthFragment",B=`#ifdef LOGARITHMICDEPTH
fragmentOutputs.fragDepth=log2(fragmentInputs.vFragmentDepth)*uniforms.logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStoreWGSL[C]||(e.IncludesShadersStoreWGSL[C]=B);const Ee={name:C,shader:B},w="oitFragment",Y=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStoreWGSL[w]||(e.IncludesShadersStoreWGSL[w]=Y);const Ie={name:w,shader:Y},E="defaultPixelShader",$=`#include<defaultUboDeclaration>
...
`;e.ShadersStoreWGSL[E]||(e.ShadersStoreWGSL[E]=$);const De=[q,j,Z,ie,oe,Q,K,fe,ne,se,le,de,ce,ve,ue,pe,he,me,Se,ge,xe,ee,J,te,re,Te,Le,Ce,we,Ee,ae,Ie];for(const r of De)e.IncludesShadersStoreWGSL[r.name]||(e.IncludesShadersStoreWGSL[r.name]=r.shader);const Fe={name:E,shader:$};export{Fe as defaultPixelShaderWGSL};
